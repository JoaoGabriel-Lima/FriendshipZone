...
export default function Home() {
  ...
  return (
    <motion.main
      ...
      exit="exit"
      variants={variants}
      className="easetransition dark:bg-black dark:bg-opacity-95"
    >
        ...
        <div className=" w-full flex justify-center items-center flex-col">
          ...
          <form>
            <input
              type="text"
              id="nameinput"
              className="bg-gray-100 text-sm dark:bg-white dark:bg-opacity-5 dark:text-white placeholder-black::placeholder dark:placeholder-white::placeholder"
            ...
            <button
              type="submit"
              id="buttoninput"
              className="font-medium text-center flex text-sm justify-center items-center"
